...
# 		require("Matrix");
	...
	#
#	mpiComm <- NULL # Make mpiComm = null, to avoid invoking mpi
...
#		print(paste0('x.train dim: ', dim(x.train)))
#		print(paste0('y.train dim: ', dim(y.train)))
#		print(paste0('x.test dim: ', dim(x.test)))
#		print(paste0('allowed dim: ', dim(allowed)))
